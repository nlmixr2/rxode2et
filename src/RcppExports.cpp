...
#include "../inst/include/rxode2et.h"
#include <Rcpp.h>
#include <string>
#include <set>
...
static int _rxode2et_RcppExport_validate(const char* sig) { 
...
RcppExport SEXP _rxode2et_RcppExport_registerCCallable() { 
    R_RegisterCCallable("rxode2et", "_rxode2et_RcppExport_validate", (DL_FUNC)_rxode2et_RcppExport_validate);
    return R_NilValue;
}
